...
4. 按 CLAUDE.md 中的 Commitlint 规范撰写 commit message，格式为 `<type>: <中文描述>`。type 从以下取值：`build`、`chore`、`ci`、`docs`、`feat`、`fix`、`perf`、`refactor`、`revert`、`style`、`test`。描述简洁（1-2 句），重点说明**为什么**改。
